...
{
    private readonly IEnhancedMetadataExtractor _extractor;
    ...
    private static WebFlux.Core.Models.EnhancedWebMetadata CreateRichMetadataForTesting()
    {
        return new WebFlux.Core.Models.EnhancedWebMetadata
        {
