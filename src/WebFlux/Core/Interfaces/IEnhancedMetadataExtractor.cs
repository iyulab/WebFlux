...
/// <summary>
/// 고급 메타데이터 추출 인터페이스
/// 15개 웹 표준 메타데이터를 포괄적으로 추출합니다
/// </summary>
public interface IEnhancedMetadataExtractor
{
    /// <summary>
    ...
    Task<EnhancedWebMetadata> ExtractMetadataAsync(
        string htmlContent,
        string sourceUrl,
    ...
    double CalculateQualityScore(EnhancedWebMetadata metadata);
    ...
    MetadataCompleteness EvaluateCompleteness(EnhancedWebMetadata metadata);
}
