...
|------|-----------------|----------|------------|
| **Auto** (권장) | 모든 웹 콘텐츠 - 자동 최적화 | ⭐⭐⭐⭐⭐ | 중간 |
| **Smart** | 기술 문서, API 문서 | ⭐⭐⭐⭐⭐ | 중간 |
| **MemoryOptimizedIntelligent** | 대규모 사이트, 서버 환경 | ⭐⭐⭐⭐⭐ | 낮음 (84% 절감) |
| **Intelligent** | 블로그, 뉴스, 지식베이스 | ⭐⭐⭐⭐⭐ | 높음 |
| **Semantic** | 일반 웹페이지, 아티클 | ⭐⭐⭐⭐ | 중간 |
| **Paragraph** | 마크다운 문서, 위키 | ⭐⭐⭐⭐ | 낮음 |
